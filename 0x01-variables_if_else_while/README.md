...
* [Everything you need to know to start with C.pdf](/rltoken/GB1UNodFfec0AXUfmSxsLA "Everything you need to know to start with C.pdf") (_You do not have to learn everything in there yet, but make sure you read it entirely first and make sure you understand the slides: “comments”, “Data types | Integer types”, “Declaration”, “Characters”, “Arithmetic operators”, “Variables assignments”, “Comparisons”, “Logical operators”, “if, if…else”, “while loops”._)
* [Keywords and identifiers](/rltoken/ckqC9BrBcMmv-DLmBauaWQ "Keywords and identifiers")
* [integers](/rltoken/Oau_6LT7-3IIt5ew_3Ac6g "integers")
* [Arithmetic Operators in C](/rltoken/r4hrHzg2X9JjnKj8sP_SAw "Arithmetic Operators in C")
* [If statements in C](/rltoken/W93uajwXtW3WOxOaeBtF-A "If statements in C")
* [if…else statement](/rltoken/PMD6eKdkj2RmIpagtABihw "if...else statement")
* [Relational operators](/rltoken/dCy4644-X_WJMYxRZwCfFQ "Relational operators")
* [Logical operators](/rltoken/gJzJXQoEdEN1Oxcutp_76Q "Logical operators")
* [while loop in C](/rltoken/Qhq1p5UcR72-VXFJ_iAqWQ "while loop in C")
* [While loop](/rltoken/RY9a1EDxRKNNHhxbJ6Pn_g "While loop")
...
At the end of this project, you are expected to be able to [explain to anyone](/rltoken/ZINxoF_40ehsu7vI2nx1qQ "explain to anyone"), **without the help of Google**:
