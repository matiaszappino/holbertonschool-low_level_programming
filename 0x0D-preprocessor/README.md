...
* [Understanding C program Compilation Process](/rltoken/UlmUG7PSamY2_qL6xze6wg "Understanding C program Compilation Process")
* [Object-like Macros](/rltoken/KAqnlwAvPZ84KI2JFlJpSg "Object-like Macros")
* [Macro Arguments](/rltoken/cJyU0mmGRx_Wd9x8WwygOQ "Macro Arguments")
* [Pre Processor Directives in C](/rltoken/A5176irunoejPUjwT3pFCQ "Pre Processor Directives in C")
* [The C Preprocessor](/rltoken/lgohqkU5DlzUBkO2MeMmHA "The C Preprocessor")
* [Standard Predefined Macros](/rltoken/C47iIZ3tGug6sklTB7hT_Q "Standard Predefined Macros")
* [include guard](/rltoken/sqLUMtBCgAAXVdhIaVoaWQ "include guard")
* [Common Predefined Macros](/rltoken/fJJUPJ-zZXlh3db00FEsJw "Common Predefined Macros")

Learning Objectives
-------------------

At the end of this project, you are expected to be able to [explain to anyone](/rltoken/q8A4cA0iZZTmv_nLXVCBQw "explain to anyone"), **without the help of Google**:
